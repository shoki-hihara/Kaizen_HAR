...
class TPN(nn.Module):
    def __init__(self, in_channels=3, feature_dim=128, input_dim=None, **kwargs):
        """
        in_channels: Conv1d の入力チャネル数 (従来の引数)
        input_dim:   HAR 用に追加した「入力次元」。指定された場合は in_channels として扱う
        """
        # ★ 互換性のためのエイリアス処理
